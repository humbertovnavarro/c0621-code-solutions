...
console.log('Value of (book 2) bookshelf[1][\'author\']:',bookshelf[1]['author']);
console.log('Value of (book 1) bookshelf[0][\'isbn\']:',bookshelf[0]['isbn']);
console.log('Value of (book 3) bookshelf[2][\'title\']:',bookshelf[2]['title']);
